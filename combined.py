...
# Normal attention layer in GPT-2
model_normal = GPT2Model.from_pretrained('gpt2')
model_normal.to(device)

# Define a function to profile attention layers
def profile_attention(model, inputs, model_type="normal"):
...
# Profile the normal attention layers
profile_attention(model_normal, input_ids, "normal")

# Profile the tiled attention layers
